...
const Header = (props) => {
    return (
        <HeaderLayout>
            { props.back_mode ? <NavBack href={'/home'}><ArrowBack src={backArrow}  alt={'Back'}/></NavBack> : ''}
            <AppLogo xmlns="http://www.w3.org/2000/svg" width="83" height="20" viewBox="0 0 83 20" version="1.1"
                 className="web-navigation__logo-vector" role="presentation">
                <path stroke="none"
